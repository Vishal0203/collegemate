                    ...
                    <div class="col-sm-8 col-sm-offset-2 form-box">
                            <div class="form-top">
                                <div class="form-top-left">
                                    <h3 class="auth">{{ $institute_name }} invitation for {{ $role }}..</h3>
                                    <p>Just a few things we need:</p>
                                </div>
                            ...
                            <div class="form-bottom">
                                <form method="POST" action="{{ URL::to('invite') . '/' . $institute_guid }}" class="login-form">
                                    ...
                                    <div class="form-group">
                                        <label style="font-weight: 400; color: #fff;">
                                            <input type="radio" name="invitation_response" value="accepted" checked>
                                            Accept
                                        </label>
                                        &nbsp;
                                        <label style="font-weight: 400; color: #fff;">
                                            <input type="radio" name="invitation_response" value="declined">
                                            Decline
                                        </label>
                                    </div>
